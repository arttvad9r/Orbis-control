...
ORIGINAL_GENERATOR_BLOB = "95625cc34c653eaa0ccc9e612fa13dd01de5ebb8"
original = subprocess.check_output(
    ["git", "cat-file", "blob", ORIGINAL_GENERATOR_BLOB], text=True
)
exec(compile(original, "theme_persistence_original.py", "exec"), {})
