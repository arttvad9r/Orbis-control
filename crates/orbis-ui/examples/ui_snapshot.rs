...
fn main() -> anyhow::Result<()> {
    ...
    match kind.as_str() {
        ...
        "fans" => {
            ...
            state.fan_temp_0 = 30; state.fan_temp_1 = 40; state.fan_temp_2 = 50; state.fan_temp_3 = 60;
            state.fan_temp_4 = 70; state.fan_temp_5 = 80; state.fan_temp_6 = 90; state.fan_temp_7 = 100;
            state.fan_pwm_0 = 0; state.fan_pwm_1 = 24; state.fan_pwm_2 = 48; state.fan_pwm_3 = 72;
            state.fan_pwm_4 = 104; state.fan_pwm_5 = 144; state.fan_pwm_6 = 196; state.fan_pwm_7 = 255;
