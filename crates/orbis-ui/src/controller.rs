...
pub struct UiState {
    ...
    /// Read-only power/thermal observations from the authoritative backend.
    pub power_limits_status: String,
    pub power_limit_spl: String,
    pub power_limit_sppt: String,
    pub power_limit_fppt: String,
    pub power_limit_gpu_boost: String,
    pub power_limit_gpu_temp_target: String,
...
impl UiState {
    ...
    pub fn production_initial() -> Self {
        Self {
            ...
            gpu_mux_value: 2,
            gpu_access_value: 3,
            power_limits_status: "Ожидание данных".into(),
            power_limit_spl: "—".into(),
            power_limit_sppt: "—".into(),
            power_limit_fppt: "—".into(),
            power_limit_gpu_boost: "—".into(),
            power_limit_gpu_temp_target: "—".into(),
    ...
    pub fn from_mock_profile(profile_name: &str) -> Self {
        ...
        Self {
            ...
            gpu_mux_value: 0,
            gpu_access_value: 0,
            power_limits_status: "Только чтение · metadata недоступна".into(),
            power_limit_spl: "—".into(),
            power_limit_sppt: "—".into(),
            power_limit_fppt: "—".into(),
            power_limit_gpu_boost: "—".into(),
